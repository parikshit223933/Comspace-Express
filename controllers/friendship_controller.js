...
module.exports.toggle_friendship = (req, res) =>
{
    ...
    Friendship.findOne({ from_user: from_id, to_user: to_id }, function (error, existing_friendship)
    {
        if (error)
        {
        ...
        if (existing_friendship)
        {
            ...
            Friendship.deleteOne({ from_user: from_id, to_user: to_id }, function (error)
            {
                if (error)
                {
